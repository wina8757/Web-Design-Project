...
<html>
    ...
    <body>
         ...
         <form width="200">
            <input type="text" name="keyword" style="height:50px; width:500px" placeholder="keyword" value="<?=$_GET['keyword']?>" />
            ...
            <select name="category">
                ...
                <option <?=checkIfSelected('Building')?> >Building</option>
                <option <?=checkIfSelected('Park')?> >Park</option>
                <option <?=checkIfSelected('School')?> >School</option>
                <option <?=checkIfSelected('Nature')?> >Nature</option>
            </select>
            </div>
            <br>
